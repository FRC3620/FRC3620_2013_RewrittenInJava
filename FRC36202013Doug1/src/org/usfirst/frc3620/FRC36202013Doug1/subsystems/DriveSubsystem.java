...
public class DriveSubsystem extends Subsystem {
    ...
    SpeedController primaryLeft = RobotMap.driveSubsystemPrimaryLeft;
    SpeedController primaryRight = RobotMap.driveSubsystemPrimaryRight;
    RobotDrive primaryDrive = RobotMap.driveSubsystemPrimaryDrive;
    SpeedController turboLeft = RobotMap.driveSubsystemTurboLeft;
    SpeedController turboRight = RobotMap.driveSubsystemTurboRight;
