...
public class RobotMap {
    ...
    public static SpeedController harversterSubsystemHarvesterController;
	...
	LiveWindow.addActuator("FlipperSubsystem", "FlipperSpike", flipperSubsystemFlipperSpike);
        ...
        harversterSubsystemHarvesterController = new Victor(1, 8);
	LiveWindow.addActuator("HarversterSubsystem", "HarvesterController", (Victor) harversterSubsystemHarvesterController);
