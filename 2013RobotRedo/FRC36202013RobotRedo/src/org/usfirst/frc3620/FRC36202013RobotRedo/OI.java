...
public class OI {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
         SmartDashboard.putData("DriveMoveInLineCommand", new DriveMoveInLineCommand(.5));
         SmartDashboard.putData("GoingBackwards", new DriveMoveInLineCommand(-0.5));
         SmartDashboard.putData("TurnRight", new DriveTurnInPlaceCommand(90));
         SmartDashboard.putData("TurnLeft", new DriveTurnInPlaceCommand(-90));
    }
