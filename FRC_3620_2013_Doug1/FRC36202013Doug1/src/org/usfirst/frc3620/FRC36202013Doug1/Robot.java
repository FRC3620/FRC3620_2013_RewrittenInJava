...
import org.usfirst.frc3620.FRC36202013Doug1.subsystems.*;
/**
...
public class Robot extends IterativeRobot {
    ...
    NetworkTable stuffNetworkTable;
    ...
    public void robotInit() {
        RobotMap.init();
        stuffNetworkTable = NetworkTable.getTable("stuff");
    ...
    public void autonomousInit() {
        onRobotModeTransition(RobotMode.AUTONOMOUS);
    ...
    public void teleopInit() {
        onRobotModeTransition(RobotMode.TELEOP);
    ...
    public void testInit() {
        onRobotModeTransition(RobotMode.TEST);
    }
    /**
    ...
    public void disabledInit() {
        onRobotModeTransition(RobotMode.DISABLED);
    }
